...
from app.api.v4.mobile.schemas import (
...
from app.api.v4.mobile.session_manager import MobileConnection, MobileSession, mobile_session_manager
from app.core.config import settings
from app.inference.manifest import get_runner


router = APIRouter(prefix="/mobile", tags=["v4-mobile"])
    ...
    try:
        while True:
            ...
            try:
                ...
                logger.exception("Mobile v4 inference failed for session %s frame %s", session_id, frame_meta.frame_id)
